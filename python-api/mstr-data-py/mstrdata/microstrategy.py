...
from mstrdata.api import projects, cubes, reports, authentication, misc
from mstrdata.utils.dfcreator import DFCreator
...
class Connection(object):
    ...
    def get_report(self, report_id, offset=0, limit=1000, raw=False):
        """
    ...
    def get_cube(self, cube_id, offset=0, limit=1000, raw=False):
        """
