...
if 'version.txt' in os.listdir():
    ...
    dist_version = '11.2.0.001'  # define the default version
...
setup(name='mstrdata-py',
      version=dist_version,
      description='Python interface for the MicroStrategy REST API',
      license='Apache License 2.0',
      url='https://github.com/MicroStrategy/mstrio-py',
      author='Benny Cheng, Scott Rigney, Peter Ott, Sergio Sainz Palacios, Michal Ciesielski, Zofia Rogala, Ignacy Hologa, Piotr Czyz',
      author_email='bcheng@microstrategy.com, srigney@microstrategy.com, ssainz@microstrategy.com, mciesielski@microstrategy.com,'
